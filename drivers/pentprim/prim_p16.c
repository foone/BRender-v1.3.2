...
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)PointRenderPIZ2_RGB_565, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softhz",(void *)"_PointRenderPIZ2_RGB_565",
#else
	NULL,NULL,
#endif
},
...
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)PointRenderPI_RGB_565, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softh",(void *)"_PointRenderPI_RGB_565",
#else
	NULL,NULL,
#endif
},
