{
...
#else
		(brp_render_fn *)PointRenderPIZ2T_RGB_888, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softtz",(void *)"_PointRenderPIZ2T_RGB_888",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)PointRenderPIZ2_RGB_888, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softtz",(void *)"_PointRenderPIZ2_RGB_888",
#else
	NULL,NULL,
#endif
},
...
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)PointRenderPIT_RGB_888, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softt",(void *)"_PointRenderPIT_RGB_888",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)PointRenderPI_RGB_888, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softt",(void *)"_PointRenderPI_RGB_888",
#else
	NULL,NULL,
#endif
},
