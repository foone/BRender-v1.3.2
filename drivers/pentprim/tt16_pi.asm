...
;;
;; $Id: tt16_pi.asm 1.1 1997/12/10 16:49:11 jon Exp $
;; $Locker: $
;;
...
;		adc	eax,ebx
	...
	.data
		db '$Id: tt16_pi.asm 1.1 1997/12/10 16:49:11 jon Exp $',0
		align 4
...
; void TriangleRenderPI_RGB_565(struct br_vertex *pvertex_0,
;			struct br_vertex *pvertex_1,
;			struct br_vertex *pvertex_2);
;
; C stub directly to triangle renderer
;
TriangleRenderPI_RGB_565 proc uses eax ebx ecx edx esi edi,
		pblock : ptr dword,
		pvertex_0 : ptr word,
		pvertex_1 : ptr word,
		pvertex_2 : ptr word
	...
	;
		...
		mov	edi,pvertex_1
		mov	ebp,pvertex_2
		call	RawTriangle_PI_RGB_565

		RESTORE_SEGS
		pop	ebp
		ret
TriangleRenderPI_RGB_565 endp
...
;
TRAPEZOID_PI_RGB_565	macro	half,dirn
...
if 1
	...
	;
		...
		TRAPEZOID_PI_RGB_565 top,f
		TRAPEZOID_PI_RGB_565 bot,f
quit:		ret
...
reversed:
	...
	;
		...
		TRAPEZOID_PI_RGB_565 top,b
		TRAPEZOID_PI_RGB_565 bot,b
		ret


	SHOW_CODESIZE	<RawTriangle_PI_RGB_565>,<%($-_setup_start)>

RawTriangle_PI_RGB_565 endp
	endif

	if PARTS and PART_16

; void TriangleRenderPII_RGB_565(struct br_vertex *pvertex_0,
;			struct br_vertex *pvertex_1,
;			struct br_vertex *pvertex_2);
;
; C stub directly to triangle renderer
;
TriangleRenderPII_RGB_565 proc uses eax ebx ecx edx esi edi,
		pblock : ptr dword,
		pvertex_0 : ptr word,
		pvertex_1 : ptr word,
		pvertex_2 : ptr word
	...
	;
		...
		mov	edi,pvertex_1
		mov	ebp,pvertex_2
		call	RawTriangle_PII_RGB_565

		RESTORE_SEGS
		pop	ebp
		ret
TriangleRenderPII_RGB_565 endp
...
;	which direction scanline are rendered from the long edge
;
TRAPEZOID_PII_RGB_565	macro	half,dirn
   	local scan_loop,pixel_loop,pixel_behind,no_pixels
	local start_carried,done_trapezoid
...
RawTriangle_PII_RGB_565 proc
	...
	;
		...
		TRAPEZOID_PII_RGB_565 top,f
		TRAPEZOID_PII_RGB_565 bot,f
quit:		ret
...
reversed:
	...
	;
		...
		TRAPEZOID_PII_RGB_565 top,b
		TRAPEZOID_PII_RGB_565 bot,b
		ret

	SHOW_CODESIZE	<RawTriangle_PII_RGB_565>,<%($-_setup_start)>
RawTriangle_PII_RGB_565 endp
	endif
