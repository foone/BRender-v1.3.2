{
	 ...
	 */
#if AUTOLOAD
	"softtz",(void *)"_TriangleRenderPIZ2TA24",
#else
	NULL,NULL,
#endif
},
{
	 ...
	 */
#if AUTOLOAD
	"softtz",(void *)"_TriangleRenderPIZ2TIA_RGB_888",
#else
	NULL,NULL,
#endif
},
...
},
{
	 ...
	 */
#if AUTOLOAD
	"softtz",(void *)"_TriangleRenderPIZ2I_RGB_888",
#else
	NULL,NULL,
#endif
},
{
	 ...
	 */
#if AUTOLOAD
	"softtz",(void *)"_TriangleRenderPIZ2_RGB_888",
#else
	NULL,NULL,
#endif
},
{
	 ...
	 */
#if AUTOLOAD
	"softt",(void *)"_TriangleRenderPITA24",
#else
	NULL,NULL,
#endif
},
{
	 ...
	 */
#if AUTOLOAD
	"softt",(void *)"_TriangleRenderPITIA_RGB_888",
#else
	NULL,NULL,
#endif
},
...
},
{
	 ...
	 */
#if AUTOLOAD
	"softt",(void *)"_TriangleRenderPII_RGB_888",
#else
	NULL,NULL,
#endif
},
{
	 ...
	 */
#if AUTOLOAD
	"softt",(void *)"_TriangleRenderPI_RGB_888",
#else
	NULL,NULL,
#endif
},
