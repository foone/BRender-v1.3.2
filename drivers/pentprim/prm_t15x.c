{
...
#else
		(brp_render_fn *)TriangleRenderPIZ2TIPB256_RGB_555, NULL,
#endif

		"RGB 555, Z Buffered, Interpolated Intensity, Textured 256x256, Perspective Correct, RGB blended", NULL,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRenderPIZ2TIPB256_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Constant Intensity, Textured 256x256, Perspective Correct, RGB blended", NULL,
...
{
	{
		...
		"RGB 555, Z Buffered, Interpolated Intensity, Textured 256x256, Perspective Correct", NULL,
		BRT_TRIANGLE, 0,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRenderPIZ2TIP256_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Constant Intensity, Textured 256x256, Perspective Correct", NULL,
...
{
	{
		...
		"RGB 555, Z Buffered, Textured 1024x1024, Perspective Correct", NULL,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRender_ZT_RGB565_D16_1024",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Textured 256x256, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_SUBDIVIDE,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRender_ZT_RGB565_D16_256",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Textured 128x128, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_SUBDIVIDE,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRender_ZT_RGB565_D16_128",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Textured 64x64, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_SUBDIVIDE,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRender_ZT_RGB565_D16_64",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Textured 32x32, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_SUBDIVIDE,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRender_ZT_RGB565_D16_32",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Textured, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_SUBDIVIDE,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRenderPIZ2TA15",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Constant Intensity, Textured, Perspective Correct", NULL,
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRenderPIZ2TIA_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Z Buffered, Interpolated Intensity, Textured, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_SUBDIVIDE,
...
{
	{
		...
		"RGB 555, Z Buffered, Textured 1024x1024", NULL,
		BRT_TRIANGLE, 0,
...
{
	{
		...
		"RGB 555, Z Buffered, Textured 256x256", NULL,
		BRT_TRIANGLE, 0,
...
{
	{
		...
		"RGB 555, Z Buffered, Textured 128x128", NULL,
		BRT_TRIANGLE, 0,
...
{
	{
		...
		"RGB 555, Z Buffered, Textured 64x64", NULL,
		BRT_TRIANGLE, 0,
...
{
	{
		...
		"RGB 555, Z Buffered, Textured 32x32", NULL,
		BRT_TRIANGLE, 0,
...
{
	{
		...
		"RGB 555, Z Buffered, Interpolated Intensity, Textured", NULL,
		BRT_TRIANGLE, 0,
...
{
	{
		...
		"RGB 555, Z Buffered, Constant Intensity, Textured", NULL,
		BRT_TRIANGLE, BR_PRIMF_CONST_DUPLICATE,
...
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)TriangleRenderPIZ2I_RGB_555, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRenderPIZ2I_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)TriangleRenderPIZ2_RGB_555, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softhzx",(void *)"_TriangleRenderPIZ2_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)TriangleRenderPITIPB256_RGB_555, NULL,
#endif

		"RGB 555, Interpolated Intensity, Textured 256x256, Perspective Correct, RGB blended", NULL,
		BRT_TRIANGLE, BR_PRIMF_BLENDED,
	 ...
	 */
#if AUTOLOAD
	"softhx",(void *)"_TriangleRenderPITIPB256_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Constant Intensity, Textured 256x256, Perspective Correct, RGB blended", NULL,
		BRT_TRIANGLE, BR_PRIMF_CONST_DUPLICATE|BR_PRIMF_BLENDED,
...
{
	{
		...
		"RGB 555, Interpolated Intensity, Textured 256x256, Perspective Correct", NULL,
		BRT_TRIANGLE, 0,
	 ...
	 */
#if AUTOLOAD
	"softhx",(void *)"_TriangleRenderPITIP256_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Constant Intensity, Textured 256x256, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_CONST_DUPLICATE,
...
{
	{
		...
		"RGB 555, Textured, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_SUBDIVIDE,
	 ...
	 */
#if AUTOLOAD
	"softhx",(void *)"_TriangleRenderPITA15",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Constant Intensity, Textured, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_CONST_DUPLICATE|BR_PRIMF_SUBDIVIDE,
	 ...
	 */
#if AUTOLOAD
	"softhx",(void *)"_TriangleRenderPITIA_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		"RGB 555, Interpolated Intensity, Textured, Perspective Correct", NULL,
		BRT_TRIANGLE, BR_PRIMF_SUBDIVIDE,
...
{
	{
		...
		"RGB 555, Interpolated Intensity, Textured", NULL,
		BRT_TRIANGLE, 0,
...
{
	{
		...
		"RGB 555, Constant Intensity, Textured", NULL,
		BRT_TRIANGLE, BR_PRIMF_CONST_DUPLICATE,
...
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)TriangleRenderPII_RGB_555, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softhx",(void *)"_TriangleRenderPII_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)TriangleRenderPI_RGB_555, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softhx",(void *)"_TriangleRenderPI_RGB_555",
#else
	NULL,NULL,
#endif
},
