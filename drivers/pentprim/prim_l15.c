{
...
#else
		(brp_render_fn *)LineRenderPIZ2T_RGB_555, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softhz",(void *)"_LineRenderPIZ2T_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)LineRenderPIZ2I_RGB_555, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softhz",(void *)"_LineRenderPIZ2I_RGB_555",
#else
	NULL,NULL,
#endif
},
...
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)LineRenderPIT_RGB_555, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softh",(void *)"_LineRenderPIT_RGB_555",
#else
	NULL,NULL,
#endif
},
{
	{
		...
		(brp_render_fn *)RenderAutoloadThunk, NULL,
#else
		(brp_render_fn *)LineRenderPII_RGB_555, NULL,
#endif
	 ...
	 */
#if AUTOLOAD
	"softh",(void *)"_LineRenderPII_RGB_555",
#else
	NULL,NULL,
#endif
},
